...
cp prod_appsettings.json ./Nailhang.Web/bin/Release/netcoreapp2.1/publish/appsettings.json
cp prod_appsettings.json ./Nailhang.Silo/bin/Release/netcoreapp2.1/publish/appsettings.json
cp prod_appsettings.json ./Nailhang.Svn/bin/Release/netcoreapp2.1/publish/appsettings.json
